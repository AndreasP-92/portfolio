...
// CATEGORIES ------------------------------------------
    ...
    server.get('/perfect-shoes/shop/:gender/:page',async function(req,res){
        ...
        try{
            res.render('projects/perfect-shoes/pages/index/shop/shop.ejs',{
...
// SEARCH FOR PRODUCT -----------------------------------
    ...
    server.post('/perfect-shoes/shop/search', async (req, res) => {
...
// WOMAN CATEGORIES --------------------------------------
    ...
    server.get('/perfect-shoes/shop',function(req,res){
...
// SPECIFIC PRODUCT ----------------------------------
    ...
    server.get('/perfect-shoes/product/:id',async function(req,res){
...
// INSERT REVIEW ---------------------------
    ...
    server.post('/perfect-shoes/shop/review/:id', async (req,res)=>{
        let productId       =   req.params.id;
        let username        =   req.session.username;
