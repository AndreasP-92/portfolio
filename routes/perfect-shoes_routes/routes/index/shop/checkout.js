...
// *********************************************************************** CHECKOUT PAGE ******************************************************************** 
    ...
    server.get('/perfect-shoes/checkout', async function(req,res){
    ...
    // CREATING PRODUCT ARRAY ------------  
        ...
        try {
            res.render('projects/perfect-shoes/pages/index/shop/checkout.ejs',{
                'username'  :   username
            })
    ...
    server.get('/perfect-shoes/finish', async function(req,res){
        let username    =   '';
        ...
        try {
            if(req.session.username){
                ...
                res.render('projects/perfect-shoes/pages/index/shop/finishCheckout.ejs',{
                    'info'      :   getInfo[0],
                    'username'  :   username,
                    'profile'   :   profile[0]
                })
...
// *********************************************************************************** CLIENT POST CART ***********************************************************
    ...
    server.post('/perfect-shoes/test',function(req,res){

        req.session.cart = req.body
        res.redirect('/perfect-shoes/checkout')
...
// CHARGING ===============================
    ...
    server.post("/perfect-shoes/charge", async (req, res) => {
...
// SEND INFORMATION TO STRIPE
        ...
        .then(res.render("projects/perfect-shoes/pages/index/shop/charge.ejs",{'username':username}))
    })
