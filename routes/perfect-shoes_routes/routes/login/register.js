...
module.exports = function (server) {
	server.get('/perfect-shoes/register', async (req, res) => {
		let username	=	req.session.username;
		try {
			res.render('projects/perfect-shoes/pages/login/register.ejs', { 
			'page'		: { 'title': 'Register' },
			'username'	: username
			});
	...
	server.get('/perfect-shoes/register/find/:user',async function(req,res){
...
// *************************************************************************** POST ***********************************************************
	...
	server.post('/perfect-shoes/user/post', async (req, res) => {
